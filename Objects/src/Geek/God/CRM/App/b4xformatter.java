...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Geek.God.CRM.App.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Geek.God.CRM.App.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public String  _addformatdata(Geek.God.CRM.App.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
double _factor = 0;
...
public Geek.God.CRM.App.b4xformatter._b4xformatdata  _copyformatdata(Geek.God.CRM.App.b4xformatter._b4xformatdata _data) throws Exception{
Geek.God.CRM.App.b4xformatter._b4xformatdata _d = null;
...
_d = new Geek.God.CRM.App.b4xformatter._b4xformatdata();
...
public Geek.God.CRM.App.b4xformatter._b4xformatdata  _createdefaultformat() throws Exception{
Geek.God.CRM.App.b4xformatter._b4xformatdata _d = null;
...
Geek.God.CRM.App.b4xformatter._b4xformatdata _data = null;
...
public Geek.God.CRM.App.b4xformatter._b4xformatdata  _getdefaultformat() throws Exception{
...
if (true) return (Geek.God.CRM.App.b4xformatter._b4xformatdata)(_formats.Get((int) (0)));
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return null;
}
public Geek.God.CRM.App.b4xformatter._b4xformatdata  _getformatdata(double _number) throws Exception{
int _i = 0;
Geek.God.CRM.App.b4xformatter._b4xformatdata _d = null;
...
_d = (Geek.God.CRM.App.b4xformatter._b4xformatdata)(_formats.Get(_i));
...
public Geek.God.CRM.App.b4xformatter._b4xformatdata  _newformatdata() throws Exception{
