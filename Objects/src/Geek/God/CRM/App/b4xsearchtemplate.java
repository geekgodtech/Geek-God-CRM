...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Geek.God.CRM.App.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Geek.God.CRM.App.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public Geek.God.CRM.App.b4xfloattextfield _searchfield = null;
...
_searchfield = new Geek.God.CRM.App.b4xfloattextfield();
...
__c.LogImpl("951576863","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(Geek.God.CRM.App.b4xsearchtemplate parent,Geek.God.CRM.App.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
Geek.God.CRM.App.b4xsearchtemplate parent;
