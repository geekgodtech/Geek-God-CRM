...
public class b4xprogressdialog extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "Geek.God.CRM.App.b4xprogressdialog");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", Geek.God.CRM.App.b4xprogressdialog.class).invoke(this, new Object[] {null});
        else
...
public Geek.God.CRM.App.b4xloadingindicator _loadingindicator = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _label1 = null;
public Geek.God.CRM.App.b4xdialog _mdialog = null;
...
_loadingindicator = new Geek.God.CRM.App.b4xloadingindicator();
...
_mdialog = new Geek.God.CRM.App.b4xdialog();
...
public String  _show(Geek.God.CRM.App.b4xdialog _dialog) throws Exception{
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((Geek.God.CRM.App.b4xdialog) args[0]);
